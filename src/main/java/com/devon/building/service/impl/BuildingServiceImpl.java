...
public class BuildingServiceImpl implements BuildingService {
    ...
    public PaginationResult<BuildingSearchResponse> getAllBuildings(
        ...
        PaginationResult<Building> buildingPage =
                buildingRepositoryCustom.queryBuilding(page, maxResult, maxNavigationPage, buildingSearchRequest);

        List<BuildingSearchResponse> results = buildingPage.getList().stream()
